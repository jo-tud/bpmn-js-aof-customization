...
function ExtendedBpmnRenderer(events, styles, pathMap) {
    ...
    var handlers = {
        ...
        'ResourcesMarker': function(p, element, position) {
            var resourcesPath = pathMap.getScaledPath('MARKER_RESOURCES', {
                xScaleFactor: 1,
                yScaleFactor: 1,
                containerWidth: element.width,
                containerHeight: element.height,
                position: {
                    mx: ((element.width-20) / element.width),
                    my: 1-((element.height - 20) / element.height)
                }
            });

            drawPath(p, resourcesPath, {
                strokeWidth: 1,
                fill: 'black'
            });
        }
...
inherits(ExtendedBpmnRenderer, DefaultRenderer);


ExtendedBpmnRenderer.$inject = [ 'eventBus', 'styles', 'pathMap' ];

module.exports = ExtendedBpmnRenderer;
