...
function ExtendedPathMap() {
  ...
  this.ExtendedPathMap = {
    ...
    'MARKER_RESOURCES': {
      d: 'm {mx},{my} m 2,0 l 5,-14 m 0,0 l 5,14 m 0,-4 q -8,-3,-10,-1 z',
      height: 14,
      width: 14,
      heightElements: [],
      widthElements: []
  ...
  this.getRawPath = function getRawPath(pathId) {
    return this.ExtendedPathMap[pathId].d;
  };
  ...
  this.getScaledPath = function getScaledPath(pathId, param) {
    var rawPath = this.ExtendedPathMap[pathId];
...
module.exports = ExtendedPathMap;
